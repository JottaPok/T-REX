...
function setup() {
  ...
  youlose = createSprite (280, 50, 0, 0)
  restart = createSprite (280, 110, 0, 0)
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(640,165,10,40);
   obstacle.velocityX = -(5.4 + score / 100);
